...
//         }
//       } else if (error) {
//         onError?.(new Error(decodeURIComponent(error)));
//         toast.error(`Authentication error: ${decodeURIComponent(error)}`);
//       }
//     };

//     handleOAuthCallback();
//   }, [token, error, from, navigate, checkAuth, onSuccess, onError]);

//   const handleOAuthLogin = (provider: OAuthProvider) => {
//     if (provider === 'google') {
//       // Add prompt=select_account to force account selection
//       const redirectUrl = "http://localhost:3000/api/auth/google?prompt=select_account";
//       window.location.href = redirectUrl;
//     } else {
//       // Handle other providers if needed
//       const redirectUrl = `http://localhost:3000/api/auth/${provider}`;
//       window.location.href = redirectUrl;
//     }
//   };

//   // On mount, set axios header from localStorage if available
//   useEffect(() => {
